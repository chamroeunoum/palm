...
if(!defined("APP_COMPONENT"))define("APP_COMPONENT",APP."components".DS);
if(!defined("APP_PLUGIN"))define("APP_PLUGIN",APP."plugins".DS);
if(!defined("APP_SERVICE"))define("APP_SERVICE",APP."services".DS);
if(!defined("APP_LIBS"))define("APP_LIBS",APP."libs".DS);
if(!defined("APP_CONFIG"))define("APP_CONFIG","../config".DS);
if(!defined("DBXML"))define("DBXML",DATA_FOLDER."dbxml".DS);
if(!defined("WEB"))define("WEB",SERVER.ROOT);
